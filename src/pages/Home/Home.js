...
const Home = () => {
   ...
   return (
      <main>
         ...
         <section>
            <div>
               <h2 className="hero__sub-header">Upcoming Event</h2>
               <p className="hero__description">Ride the Tide Paddling Event to benefit WNC impacted by Hurricane Helene, Saturday, November 16</p>
            </div>
         </section>
         ...
         <section className="donate">
            <div className="donate__cont">
               ...
               <ul className="donate__ul">
                  <li className="donte__items">MountainStrong Hurricane Recovery Fund - <a href="https://mountaintrue.org/mountainstrong" target="_blank" rel="noopener noreferrer">mountaintrue.org/mountainstrong</a></li>
                  <li className="donte__items">WNC NonProfit Disaster Relief - <a href="https://hellorhighwaternc.com" target="_blank" rel="noopener noreferrer">hellorhighwaternc.com</a></li>
                  <li className="donte__items">Helene Rebuild Collaborative - <a href="https://hurricanehelenewnc.com" target="_blank" rel="noopener noreferrer">hurricanehelenewnc.com</a></li>
               </ul>
         ...
         <div className="cancel">
            ...
            <p className="cancel__description">If you cancel within 24 hours of the event, no refund is issued. For weather-related cancellations, Kayak Carolina will offer rescheduling or refunds as needed.</p>
         </div>

         <div className="button">
            <a href="YOUR_DONATION_SITE_URL" className="button__donate">Donate</a>
            <a href="https://kayakcarolina.com/kayak-tours/" className="button__book">Book a Trip</a>
         </div>
    </main>
   );
};
